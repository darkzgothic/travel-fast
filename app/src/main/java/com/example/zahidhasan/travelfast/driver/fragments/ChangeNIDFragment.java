...
public class ChangeNIDFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_change_nid, container, false);
    ...
    private void getNIDImage() {
        ...
        driverRef.orderByChild("email").equalTo(_email).addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                StorageReference st = storage.getReferenceFromUrl(drivers.getNidImg());
                ...
                if (txt.equals("Save Image")){
                    ...
                    if (filePath != null){
                        ...
                        StorageReference nidImgRef = storageReference.child("Drivers"+"/"+_folderName[0]+"/"
                                + _folderName[0] +"-"+"nidImg"+ "." + getFileExtension(filePath));

                        nidImgRef.putFile(filePath)
                                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                    ...
                                    public void onSuccess(final UploadTask.TaskSnapshot taskSnapshot) {
                                        ...
                                        Toast.makeText(getActivity(), "NID Image Uploaded ", Toast.LENGTH_LONG).show();
                                    }
                                })
        ...
        if (resultCode == RESULT_OK && data != null && data.getData() != null) {
            if (requestCode == PICK_IMAGE_REQUEST) {
                ...
                try {
                    ...
                    nidImage.setImageBitmap(bitmap);
    ...
    private void initComponent(View v) {
        nidImage = (ImageView) v.findViewById(R.id.nid_img);
        button = (Button) v.findViewById(R.id.nid_img_btn);
